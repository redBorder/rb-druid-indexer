...
var FlowDimensions = []string{
	...
	"lan_ip", "lan_ip_is_malicious", "lan_ip_malicious_source", "lan_ip_malicious_score", 
	"lan_ip_as_name", "lan_ip_country_code", "lan_ip_name",
	...
	"public_ip", "public_ip_is_malicious", "public_ip_malicious_source", "public_ip_malicious_score",
	"public_ip_mac", "referer", "referer_l2",
	...
	"wan_interface_name", "wan_ip", "wan_ip_is_malicious", "wan_ip_malicious_source", "wan_ip_malicious_score",
	"wan_ip_as_name", "wan_ip_country_code",
